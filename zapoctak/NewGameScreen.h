	...
	namespace Screens {
		...
		protected:
			...
			virtual void InitializeComponents() override {
				...
				//player 2 colors
				components.emplace_back(std::make_unique<Components::Buttons::BaseButton>(app_mngr, [&]() { app_mngr.GetPlayers()[0].tank.color = BasicStructres::Color{ 0xbf0303 }; (*((Components::Others::TextComponent*) (this->GetComponents()[8]).get())).ChangeTextColor(BasicStructres::Color{ 0xbf0303 }); 	}, "", BasicStructres::SizeAndPos{ 310,265,30,30 }, BasicStructres::Color{ 0xbf0303 }, BasicStructres::Color{ 0xbf0303 }));
				components.emplace_back(std::make_unique<Components::Buttons::BaseButton>(app_mngr, [&]() { app_mngr.GetPlayers()[0].tank.color = BasicStructres::Color{ 0x007f10 }; (*((Components::Others::TextComponent*) (this->GetComponents()[8]).get())).ChangeTextColor(BasicStructres::Color{ 0x007f10 }); 	}, "", BasicStructres::SizeAndPos{ 350,265,30,30 }, BasicStructres::Color{ 0x007f10 }, BasicStructres::Color{ 0x007f10 }));
				...
				components.emplace_back(std::make_unique<Components::Buttons::BaseButton>(app_mngr, [&]() { app_mngr.GetPlayers()[0].tank.color = BasicStructres::Color{ 0x7f006e }; (*((Components::Others::TextComponent*) (this->GetComponents()[8]).get())).ChangeTextColor(BasicStructres::Color{ 0x7f006e }); 	}, "", BasicStructres::SizeAndPos{ 430,265,30,30 }, BasicStructres::Color{ 0x7f006e }, BasicStructres::Color{ 0x7f006e }));
				components.emplace_back(std::make_unique<Components::Buttons::BaseButton>(app_mngr, [&]() { app_mngr.GetPlayers()[0].tank.color = BasicStructres::Color{ 0xeaae46 }; (*((Components::Others::TextComponent*) (this->GetComponents()[8]).get())).ChangeTextColor(BasicStructres::Color{ 0xeaae46 }); 	}, "", BasicStructres::SizeAndPos{ 470,265,30,30 }, BasicStructres::Color{ 0xeaae46 }, BasicStructres::Color{ 0xeaae46 }));
				components.emplace_back(std::make_unique<Components::Buttons::BaseButton>(app_mngr, [&]() { app_mngr.GetPlayers()[0].tank.color = BasicStructres::Color{ 0x000000 }; (*((Components::Others::TextComponent*) (this->GetComponents()[8]).get())).ChangeTextColor(BasicStructres::Color{ 0x000000 }); 	}, "", BasicStructres::SizeAndPos{ 510,265,30,30 }, BasicStructres::Color{ 0x000000 }, BasicStructres::Color{ 0x000000 }));
		...
		public:
			NewGameScreen(TanksGame::TanksAppManager & game_manager) :BasicStaticScreen(game_manager) {
				...
				players.emplace_back(Components::Game::Player{ "Player 1", Components::Game::TankProperties{1, 100}, 10000 });
				players.emplace_back(Components::Game::Player{ "Player 2", Components::Game::TankProperties{2, 800}, 10000 });
